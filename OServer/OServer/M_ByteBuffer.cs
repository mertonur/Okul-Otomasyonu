...
public class M_ByteBuffer : IDisposable //Tek Kullanımlık
{
    ...
    {
        Buffer.AddRange(BitConverter.GetBytes(Encoding.UTF8.GetByteCount(Giris)));
        Buffer.AddRange(UTF8Encoding.UTF8.GetBytes(Giris));
        buffer_guncelle = true;
    }
    ...
    public string String_Oku(bool Dikiz = true)
    {
        ...
        string ret = UTF8Encoding.UTF8.GetString(okunan_buffer, okunanPos, len);
